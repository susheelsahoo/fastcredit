<section class="footer-area bg-top pt-100 pb-70">
        <div class="container">
            <div class="row">
    ...
    <div class="copy-right-area">
        <div class="container">
            <div class="copy-right-content">
                <p>
                    Copyright © 2021 Fast Credit Deal. Designed By
                    <a href="http://indiaivrbox.com/" target="_blank">
                        IVRBOX Technology Pvt. Ltd
                    </a>
                </p>
            </div>
        </div>
